...
public class Tasks {
	...
	public int[] order()
	// this method run while counter < num that means that not all the order in
	// place
	// and goes over the "depends" and "wait" array to check if it possible to put
	// the task in "orderOfTasks"
	{
		int i, counter = 0;
		while (counter < num) {
			for (i = 0; i < num; i++) {
